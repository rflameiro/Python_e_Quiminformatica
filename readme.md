Notebooks em português-BR contendo uma revisão de funcionalidades da linguagem Python e tutoriais de quiminformática (programação aplicada a problemas de química) usando a linguagem Python.
